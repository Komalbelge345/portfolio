    ...
    <div id="home">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center p-10 md:p-0 pt-10">
        <div className="col md:p-8 lg:p-16 order-2 md:order-1 overflow-visible">
          ...
          <h1 className="text-md my-3 font-[500]">
            {" "}
            I am an enthusiastic and dedicated individual, eager to utilize my
            skills and knowledge to create meaningful and impactful projects.
          </h1>
          <br />
          <a
            href="/KomalBelgeResume.pdf"
            download="KomalBelgeResume"
            className="py-2 px-4 border-2 border-[black] bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg font-semibold"
          >
            Download CV
          </a>
        </div>
